...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-1xs94xw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-1xs94xw.containers.anotherwebservice.com/
...
```
git clone git@github.com:WardenMatthiasStark/container-1xs94xw.git
cd container-1xs94xw
```
...
```
docker attach container-1xs94xw
```
